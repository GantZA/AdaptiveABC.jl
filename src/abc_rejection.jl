function ABCRejection(abc_input::ABCInput, n_sims::Int, n_reps::Int; store_init=false, parallel=false)
...
function ABCRejection(abc_input::ABCInput, n_sims::Int, n_reps::Int, k::Int; store_init=false, parallel=false)
    out = ABCRejection(abc_input, n_sims, n_reps, store_init=store_init, parallel=parallel)
...
function ABCRejection(abc_input::ABCInput, n_sims::Int, n_reps::Int, h::AbstractFloat; store_init=false, parallel=false)
    out = ABCRejection(abc_input, n_sims, n_reps, store_init=store_init, parallel=parallel)
